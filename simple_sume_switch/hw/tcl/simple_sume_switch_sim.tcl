...
read_verilog "$::env(NF_DESIGN_DIR)/hw/hdl/axi_stream_fifo/axi_stream_fifo.v"
read_verilog "$::env(NF_DESIGN_DIR)/hw/hdl/rank_pipe/strict_rank.v"
...
read_verilog "$::env(NF_DESIGN_DIR)/hw/hdl/simple_output_queues/simple_output_queues.v"
